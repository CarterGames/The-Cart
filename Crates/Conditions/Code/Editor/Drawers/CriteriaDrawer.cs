    ...
    public static class CriteriaDrawer
    {
	    ...
	    public static void DrawCriteria(DataEditorCriteria criteriaEntry)
	    {
		    ...
		    var label = (string) (ReflectionHelper
			    .GetProperty(criteriaEntry.Criteria.targetObject.GetType(), "DisplayName", true, false)
		    ...
		    if (criteriaEntry.CanChangeGroup)
		    {
			    ...
			    if (GUILayout.Button("Change Group", GUILayout.Width(100)))
			    {
				    ...
				    SearchProviderManager.GetProvider<SearchProviderConditionGroups>().SelectionMadeEvt.Add(Listener);
	    ...
	    {
		    SearchProviderManager.GetProvider<SearchProviderConditionGroups>().SelectionMadeEvt.Clear();
