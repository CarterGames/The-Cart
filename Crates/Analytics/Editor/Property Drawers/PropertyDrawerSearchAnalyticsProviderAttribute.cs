...
{
    [CustomPropertyDrawer(typeof(SearchAnalyticsProviderAttribute))]
    public class PropertyDrawerSearchAnalyticsProviderAttribute : PropertyDrawerSearchProviderSelectable<SearchProviderAnalyticsProvider, AssemblyClassDef>
    {
        /* ─────────────────────────────────────────────────────────────────────────────────────────────────────────────
        |   Properties
        ───────────────────────────────────────────────────────────────────────────────────────────────────────────── */
        
        protected override SearchProviderAnalyticsProvider Provider => SearchProviderAnalyticsProvider.GetProvider();
        protected override string InitialSelectButtonLabel => "Select Analytics Provider";
